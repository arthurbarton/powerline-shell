...
#
# For instructions on how to use the powerline-shell.py script,
# see the README

# Add, remove or rearrange these segments to customize what you see
# on the shell prompt.
# Any segment you add must be present in the segments/ directory
...
# Show a padlock when ssh-ing from another machine
    'ssh',
# Show current python virtual environment (see http://www.virtualenv.org/)
    'virtual_env',
